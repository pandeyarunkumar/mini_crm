    ...
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            ...
            <div id="mySidenav" class="sidenav">
                ...
                <a class="side-nav" href="{{ route('get-companies') }}">Company</a>
                <a class="side-nav" href="{{ route('get-employees') }}">Employee</a>
                <a class="side-nav" href="{{ route('get-projects') }}">Project</a>
            </div>
        </nav>
